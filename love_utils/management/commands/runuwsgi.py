...
class Command(BaseCommand):
    """
    Command for run the project with the help of uWSGI

    python manage.py runuwsgi --port 9000 \
                    --socket /tmp/project.sock --home /path/to/project/env --chdir /path/to/project \
                    --module app.wsgi --autoreload 1 \
                    --static-map /static=/path/to/project/data/static/dev \
                    --static-map /=/path/to/project/repo/dev/htdocs \
    ...
    help = 'Run the project with the help of uWSGI.'
